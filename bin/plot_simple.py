...
combined_df = pd.read_csv(args.combined_csv, 
    sep=',', 
    header=0, 
    names = ['sample_id', 'patient_id', 'timepoint', 'origin', 'num_clones', 'num_TCRs', 'simpson_index', 'simpson_index_corrected', 'clonality'])
...
# Plot clonality before and after treatment
# sns.boxplot(data=combined_df, x='timepoint', y='clonality')
# sns.set(rc={'figure.figsize':(8,6)})
# sns.set_style('whitegrid')
# sns.despine()

# # Plot num_clones before and after treatment
# sns.boxplot(data=combined_df, x='timepoint', y='num_clones', showfliers=False)
# sns.stripplot(data=combined_df, x='timepoint', y='num_clones', color='black', size=4)
# sns.set(rc={'figure.figsize':(8,6)})
# sns.set_style('whitegrid')
# sns.despine()
# plt.savefig('num_clones_plot.png')

# # Plot num_TCRs before and after treatment
# sns.boxplot(data=combined_df, x='timepoint', y='num_TCRs', showfliers=False)
# sns.stripplot(data=combined_df, x='timepoint', y='num_TCRs', color='black', size=4)
# sns.set(rc={'figure.figsize':(8,6)})
# sns.set_style('whitegrid')
# sns.despine()
# plt.savefig('num_TCRs_plot.png')

# # Plot clonality before and after treatment
# sns.boxplot(data=combined_df, x='timepoint', y='clonality', showfliers=False)
# sns.stripplot(data=combined_df, x='timepoint', y='clonality', color='black', size=4)
# sns.set(rc={'figure.figsize':(8,6)})
# sns.set_style('whitegrid')
# sns.despine()
# plt.savefig('clonality_plot.png')

# # Plot corrected simpson index before and after treatment
# sns.boxplot(data=combined_df, x='timepoint', y='simpson_index_corrected')
# sns.set(rc={'figure.figsize':(8,6)})
# sns.set_style('whitegrid')
# sns.despine()
# plt.savefig('simpson_index_corrected_plot.png')
